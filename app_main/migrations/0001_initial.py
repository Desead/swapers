    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_in_site', models.BooleanField(default=True, verbose_name='Показывать на сайте')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_session_timeout_min', models.PositiveIntegerField(default=20, help_text='Через сколько минут бездействия разлогинивать из админки. 0 — не разлогинивать по простою (сессия живёт до закрытия браузера).', verbose_name='Автовыход из админки, минут')),
                ...
                ('stablecoins', models.TextField(blank=True, default='USDT, USDC, PYUSD, FDUSD, TUSD, USDP, GUSD, DAI, USDS, USDe, RLUSD, frxUSD, FRAX, LUSD, GHO, crvUSD, sUSD, DOLA, MIM, USDD, USDM, USDV, USD0, USDH, HAY, alUSD, USX, VAI, eUSD, GRAI, USK, DJED, USDA, BOLD, USDK,EURC, EURT, EURS, EUROe, EURe, EURA, AEUR, EURI, EURR, agEUR, cEUR, jEUR, PAR,GBPT, GBPe,XSGD, XIDR, BRZ, MXNT,XCHF, VCHF, HCHF,GYEN, JPYC,ZARP,QCAD, CADC,TRYB,TAUD, AUDD', help_text='Через запятую (например: USDT, USDC, DAI).', verbose_name='Стейблкоины')),
                ('memo_required_chains', models.TextField(blank=True, default='XRP, XLM, EOS, TON, NOT, ATOM, OSMO, KAVA, LUNC, LUNA, BNB, XEM, HBAR', help_text='Через запятую. (например: XRP, TON, BNB).', verbose_name='Сети с MEMO/TAG')),
                ('fiat_name', models.TextField(blank=True, default='AED, AFN, ALL, AMD, ANG, AOA, ARS, AUD, AWG, AZN, BAM, BBD, BDT, BGN, BHD, BIF, BMD, BND, BOB, BRL, BSD, BTN, BWP, BYN, BZD, CAD, CDF, CHF, CLP, CNY, COP, CRC, CUP, CVE, CZK, DJF, DKK, DOP, DZD, EGP, ERN, ETB, EUR, FJD, FKP, GBP, GEL, GHS, GIP, GMD, GNF, GTQ, GYD, HKD, HNL, HTG, HUF, IDR, ILS, INR, IQD, IRR, ISK, JMD, JOD, JPY, KES, KGS, KHR, KMF, KPW, KRW, KWD, KYD, KZT, LAK, LBP, LKR, LRD, LSL, LYD, MAD, MDL, MGA, MKD, MMK, MNT, MOP, MRU, MUR, MVR, MWK, MXN, MYR, MZN, NAD, NGN, NIO, NOK, NPR, NZD, OMR, PAB, PEN, PGK, PHP, PKR, PLN, PYG, QAR, RON, RSD, RUB, RWF, SAR, SBD, SCR, SDG, SEK, SGD, SHP, SLE, SOS, SRD, SSP, STN, SYP, SZL, THB, TJS, TMT, TND, TOP, TRY, TTD, TWD, TZS, UAH, UGX, USD, UYU, UZS, VED, VES, VND, VUV, WST, XAF, XCD, XOF, XPF, YER, ZAR, ZMW, ZWG', help_text='Через запятую. (например: EUR, USD, RUB).', verbose_name='Фиатные валюты')),
                ...
                ('fee_percent', models.DecimalField(decimal_places=8, default=0.5, help_text='Процент с каждой сделки (0–100).', max_digits=20, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Комиссия обменника, %')),
                ...
                ('telegram_bot_token', models.CharField(blank=True, default='8466199664:AAENH-MHZ-KwbohoWDSNi5Hezh1rZvPTCVQ', help_text='Токен бота для уведомлений (хранится как есть).', max_length=255, verbose_name='Telegram Bot Token')),
                ('telegram_chat_id', models.CharField(blank=True, default='-1003026092644', help_text='ID  канала/чата, куда слать служебные уведомления. Чтобы узнать ID запустите бота: @username_to_id_bot', max_length=64, verbose_name='Telegram Chat/Channel ID')),
                ...
                ('site_enabled_languages', models.JSONField(blank=True, default=list, help_text='Какие языки показывать на сайте (переключатель, hreflang). Если пусто — будет только основной язык.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('ru', 'Russian'), ('en', 'English'), ('de', 'German'), ('fr', 'French'), ('es', 'Spanish'), ('it', 'Italian'), ('uk', 'Ukrainian')], default='ru', max_length=8, verbose_name='Язык общения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', django_ckeditor_5.fields.CKEditor5Field(blank=True, verbose_name='Содержимое')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Bestchange', max_length=120, unique=True, verbose_name='Название')),
                ('link', models.URLField(default='https://www.bestchange.ru/', max_length=500, verbose_name='Ссылка')),
                ('number', models.PositiveIntegerField(default=100, verbose_name='Место на сайте')),
                ('is_active', models.BooleanField(default=True, verbose_name='Включён')),
                ('clicks_total', models.PositiveIntegerField(default=0, editable=False, verbose_name='Кликов всего')),
                ('last_click_at', models.DateTimeField(blank=True, editable=False, null=True, verbose_name='Последний клик')),
                ('percent', models.DecimalField(decimal_places=8, default=Decimal('30'), max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('0')), django.core.validators.MaxValueValidator(Decimal('100'))], verbose_name='Партнёрский процент')),
                ('partner_type', models.IntegerField(choices=[(1, 'От прибыли'), (2, 'От полной суммы')], default=1, verbose_name='Тип партнёрки')),
                ('balance_usdt', models.DecimalField(decimal_places=8, default=Decimal('0'), editable=False, help_text='Сумма к выплате с момента последнего вывода.', max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Текущий Баланс (USDT)')),
                ('total_profit_usdt', models.DecimalField(decimal_places=8, default=Decimal('0'), editable=False, help_text='Накопленная сумма за всё время.', max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Общая прибыль (USDT)')),
                ('last_payout_at', models.DateTimeField(blank=True, editable=False, null=True, verbose_name='Дата последнего списания средств')),
                ('last_payout_amount_usdt', models.DecimalField(decimal_places=8, default=Decimal('0'), editable=False, max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Сумма последнего вывода (USDT)')),
                ('api_access', models.BooleanField(default=False, verbose_name='Доступ к API')),
                ('title', models.CharField(blank=True, default='Оставить отзыв о нас', max_length=120, null=True, verbose_name='Оставить отзыв о нас')),
                ('comment', models.TextField(blank=True, default='', verbose_name='Комментарий')),
                ('banner_dark_asset', models.ForeignKey(blank=True, limit_choices_to={'theme': 'dark'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monitorings_dark', to='app_library.bannerasset', verbose_name='Баннер (тёмный) из библиотеки')),
                ('banner_light_asset', models.ForeignKey(blank=True, limit_choices_to={'theme': 'light'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monitorings_light', to='app_library.bannerasset', verbose_name='Баннер (светлый) из библиотеки')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SiteSetupTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('copyright_field', models.CharField(blank=True, default='Обменник для умных', help_text='Отображается сразу после © и текущего года', max_length=50, verbose_name='Копирайт в подвал')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='app_main.sitesetup')),
            ],
            options={
                'verbose_name': 'Настройки сайта Translation',
                'db_table': 'app_main_sitesetup_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
            },
