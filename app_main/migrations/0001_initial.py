    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stablecoins', models.TextField(blank=True, default='USDT, USDC, PYUSD, FDUSD, TUSD, USDP, GUSD, DAI, USDS, USDe, RLUSD, frxUSD, FRAX, LUSD, GHO, crvUSD, sUSD, DOLA, MIM, USDD, USDM, USDV, USD0, USDH, HAY, alUSD, USX, VAI, eUSD, GRAI, USK, DJED, USDA, BOLD, USDK,EURC, EURT, EURS, EUROe, EURe, EURA, AEUR, EURI, EURR, agEUR, cEUR, jEUR, PAR,GBPT, GBPe,XSGD, XIDR, BRZ, MXNT,XCHF, VCHF, HCHF,GYEN, JPYC,ZARP,QCAD, CADC,TRYB,TAUD, AUDD', help_text='Через запятую (например: USDT, USDC, DAI).', verbose_name='Список стейблкоинов')),
                ('memo_required_chains', models.TextField(blank=True, default='XRP, XLM, EOS, TON, NOT, ATOM, OSMO, KAVA, LUNC, LUNA, BNB, XEM, HBAR', help_text='Через запятую. (например: XRP, TON, BNB).', verbose_name='Сети, где требуется MEMO/TAG')),
