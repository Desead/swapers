...
import app_main.models_monitoring
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent', models.DecimalField(decimal_places=8, default=Decimal('0'), max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('0')), django.core.validators.MaxValueValidator(Decimal('100'))], verbose_name='Партнёрский процент')),
