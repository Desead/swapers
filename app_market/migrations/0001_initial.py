    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange_kind', models.CharField(choices=[('CEX', 'Классическая биржа (CEX)'), ('DEX', 'Децентрализованная биржа (DEX)'), ('PSP', 'Платёжная система (PSP)'), ('WALLET', 'Кошелёк'), ('NODE', 'Нода'), ('EXCHANGER', 'Обменники'), ('BANK', 'Банк'), ('MANUAL', 'Ручной обмен (возможно в офисе)')], db_index=True, default='CEX', editable=False, help_text='Устанавливается автоматически', max_length=10, verbose_name='Тип')),
                ...
                ('spot_taker_fee', models.DecimalField(decimal_places=5, default=Decimal('0.1'), help_text='Может быть отрицательной.', max_digits=12, verbose_name='Спот: тейкер, %')),
                ('spot_maker_fee', models.DecimalField(decimal_places=5, default=Decimal('0.1'), help_text='Может быть отрицательной.', max_digits=12, verbose_name='Спот: мейкер, %')),
                ('futures_taker_fee', models.DecimalField(decimal_places=5, default=Decimal('0.1'), help_text='Может быть отрицательной.', max_digits=12, verbose_name='Фьючерсы: тейкер, %')),
                ('futures_maker_fee', models.DecimalField(decimal_places=5, default=Decimal('0.1'), help_text='Может быть отрицательной.', max_digits=12, verbose_name='Фьючерсы: мейкер, %')),
                ('fee_deposit_percent', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, verbose_name='Ввод: %')),
                ('fee_deposit_fixed', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, verbose_name='Ввод: фикс')),
                ('fee_deposit_min', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Ввод: мин. комиссия')),
                ('fee_deposit_max', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Ввод: макс. комиссия')),
                ('fee_withdraw_percent', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, verbose_name='Вывод: %')),
                ('fee_withdraw_fixed', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, verbose_name='Вывод: фикс')),
                ('fee_withdraw_min', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Вывод: мин. комиссия')),
                ('fee_withdraw_max', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Вывод: макс. комиссия')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset_code', models.CharField(db_index=True, max_length=32, verbose_name='Тикет')),
                ('asset_name', models.CharField(blank=True, default='', max_length=128, verbose_name='Название')),
                ('chain_code', models.CharField(db_index=True, max_length=64, verbose_name='Сеть')),
                ('chain_display', models.CharField(blank=True, default='', max_length=128, verbose_name='Сеть экран')),
                ...
                ('deposit_fee_percent', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Комиссия ввода, %')),
                ...
                ('deposit_min_usdt', models.DecimalField(decimal_places=10, default=Decimal('0'), max_digits=28, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Мин. ввод (в USDT)')),
                ...
                ('withdraw_fee_percent', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Комиссия вывода, %')),
                ...
                ('withdraw_min_usdt', models.DecimalField(decimal_places=10, default=Decimal('0'), max_digits=28, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Мин. вывод (в USDTт)')),
