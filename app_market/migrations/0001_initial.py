    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange_kind', models.CharField(choices=[('CEX', 'Классическая биржа (CEX)'), ('DEX', 'Децентрализованная биржа (DEX)'), ('PSP', 'Платёжная система (PSP)'), ('WALLET', 'Кошелёк'), ('NODE', 'Нода'), ('EXCHANGER', 'Обменники'), ('BANK', 'Банк'), ('CASH', 'Ручной обмен (возможно в офисе)')], db_index=True, default='CEX', editable=False, help_text='Устанавливается автоматически', max_length=10, verbose_name='Тип')),
                ...
                ('fee_deposit_min', models.DecimalField(decimal_places=5, default=Decimal('0'), max_digits=28, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Ввод: мин. комиссия')),
